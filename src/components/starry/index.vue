...
.starfield .moving-1 {
    ...
    animation: star-movement 50s linear infinite;
}

div.starfield .moving-1:after {
    content: " ";
    position: absolute;
    top: 2000px;
    width: 1px;
...
.starfield .moving-3 {
    ...
    animation: star-movement 150s linear infinite;
}

div.starfield .moving-3:after {
    content: " ";
    position: absolute;
    top: 2000px;
    width: 3px;
